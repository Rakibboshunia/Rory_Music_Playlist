...
export default function Step1_EventType() {
  ...
  return (
    <div className="max-w-xl mx-auto px-6">
      <h1 className="text-5xl text-center mb-8">Your night. Your energy. <br /> Your soundtrack.</h1>
      <p className="text-center text-xl text-gray-700 mb-8">From vision to reality in there simple steps.</p>
      {/* Progress */}
      ...
      <div className="bg-white rounded-2xl shadow p-6 space-y-4">
        ...
        {options.map((item) => {
          ...
          return (
            <button
              ...
              className={`
                w-full h-[56px] rounded-xl border text-base font-medium transition
                ${
                  selected
        ...
        <div className="flex justify-end pt-4">
          <button
            ...
            className={`
              px-6 py-2 rounded-full text-white transition
              ${
                answers.eventType
