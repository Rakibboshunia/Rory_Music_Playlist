  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full bg-white border-t border-black p-6 md:px-20 z-50 shadow-xl">
      <p className="text-xl text-black leading-relaxed">
        We use cookies to make Soundtrack My Night work properly, understand how
        visitors use the site, and improve your experience. Some cookies are
        essential, while others help us analyse usage and personalise content.
      </p>
