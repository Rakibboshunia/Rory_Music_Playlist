    ...
    <section className="relative py-24 px-6 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-5 leading-relaxed">
            After performing at thousands of weddings, we’ve seen how much the right music shapes the atmosphere of a night. This tool was built to help couples discover better song ideas faster based on real experience.
          </p>
        ...
        <div className="relative flex justify-center">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl p-8 text-center hover:scale-105 transition duration-300">
            ...
            {/* Small divider */}
            <div className="w-10 h-[2px] bg-gradient-to-r from-purple-600 to-pink-500 mx-auto mt-4 rounded-full" />
          </div>
        </div>
